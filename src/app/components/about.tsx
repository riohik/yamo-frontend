        ...
        <Template>
            <div className="flex flex-row items-center">
                ...
                <div className="flex flex-col justify-center items-start gap-5 w-3/5 pr-20">
                    ...
                    <p className="text-left">
                        また、少し古い言葉になりますが、
                        和歌などの語尾に「やも」と用いることで、 「仮説」や「詠嘆」の意味をもつことがあります。
                    </p>
                    <p className="text-left">
                        常に「〇〇かなあ」と疑問符を持ち、吐露し合うこと。 心で思ったことを伝え合う関係性があってこそ 良いチーム、良い映像を制作できると考えています。
                    </p>
                    <p className="text-left">
                        この社名に込めた言葉の意味を大切に、 映像で八方を虜にできるような「やも」を目指して、 精進し続けていきます。
                    </p>
                </div>
            </div>
        </Template>
