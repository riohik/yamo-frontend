            ...
            <div className="flex flex-row items-center gap-2 p-1">
                ...
                <div className="flex flex-col justify-center items-start gap-10 w-3/5 lg:pr-20 text-xs lg:text-xl">
                    <p className="text-left">
                        お客様がつくりたい映像を制作するために<br className="block" />最適なチーム作りから<br className="lg:hidden block" />考える会社です。
                    </p>
                    <p className="text-left">
                        今まで映像制作に携わってきた経験を踏まえ、<br className="block" />コストを抑えながら、<br className="lg:hidden block" />機動力を持って、<br className="block" />どのようなメンバーで<br className="lg:hidden block" />映像を制作することが<br className="block" />最高の結果を導くことが<br className="lg:hidden block" />できるのか。
                    </p>
                    <p className="text-left">
